    ...
    def is_bigger(self,a , b, this_color):
        ...
        if a[0] == self.main_color:
            if b =='jk' or b=='JK' or b[1]==self.main_num or b[0]==self.main_color and self.is_big(b[1],a[1]):
                ...
                return True
        if a[0] == this_color:
            if b =='jk' or b=='JK' or b[1]==self.main_num or b[0]==self.main_color or b[0]==this_color and self.is_big(b[1],a[1]):
                return False
            else:
                return True
        
        if b =='jk' or b=='JK' or b[1]==self.main_num or b[0]==self.main_color or b[0]==this_color or self.is_big(b[1],a[1]):
            return False
        else:
            return True
    ...
    def run_game(self, background):
        ...
        for i in range(12):
            ...
            if not self.is_a_card(first_card):
                ...
                self.false[turn] += 1
            if first_card == 'jk' or first_card == 'JK' or first_card[0]==self.main_color or first_card[1]==self.main_num:
